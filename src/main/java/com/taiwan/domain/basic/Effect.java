...
public class Effect {
     ...
     */
    private Integer clearTargetState;
    /**
     * 是否使用标准重力， 并且无视阻挡
     */
     ...
     */
    private String hitFloatXForce;
    /**
     * 打到空中敌人是否有Y轴推力 (1100等于1） （若只填写浮空力且此处填0，则默认对空中单位的Y轴推力为浮空力，所以不想让敌人浮空，此处最小值可填10）
     */
    private String hitFloatYForce;
    /**
