...
public class Monster {
     ...
     */
    private Integer enhanceRadius;
    /**
     * 强制指定头顶高度 （浮点） 怪物头顶说话框，血条，施法条
     */
    private Integer overHeadHeight;
    /**
     * 指定上头顶buff高度 （浮点） 影响怪物名字
     */
    private Integer buffOriginHeight;
    /**
     ...
     * 出生能力设定 (0表示不改)
     */
    private Integer abilityChange;
    /**
     * 出生buff，可以填多个|
     */
    private Integer bornBuff;
    /**
     * 出生buff2，这里填Buff信息表可以填多个|
     */
    private Integer bornBuff2;
    /**
     * 出生携带机制 （可以填多个）
     */
    private Integer bornMechanism;
    /**
