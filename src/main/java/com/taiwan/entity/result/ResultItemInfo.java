...
import com.taiwan.domain.basic.EqSuitScore;
import lombok.Data;
...
public class ResultItemInfo {
    ...
    /**
     * 颜色CL_NONE:0:没有WHITE:1:白BLUE:2:蓝PURPLE:3:紫GREEN:4:绿PINK:5:粉YELLOW:6:橙
     */
    ...
    /**
     * 装备禁止使用的功能IPOE_INVALE:0:无IPOE_STRENG:1:强化IPOE_UPGRADE:2:升级IPOE_ADDMAGIC:3:附魔IPOE_MOUNTBEAD:4:宝珠IPOE_DECOMPOSE:5:分解IPOE_ENHANCE:6:激化IPOE_CLEARSMELL:7:清除气息IPOE_REDACTIVE:8:激活IPOE_REDCHAGE:9:转化
     */
    ...
    private ResultGiftPackItem giftPack;

    private String attachBuffDesc;
    
    private List attribute;
    //增幅属性
    private Integer enhAttribute;

    //宝珠消息
    private Map<String,Object> bead;
    //是否打造
    private Boolean isForge = false;
    //套装信息
    private ResultEqSuit eqSuit;
    //穿戴装备信息
    private ResultItemInfo wearEqInfo;
    ...
    //宝珠属性(如果他有的话
    private ResultBeadIsEq beadIsEq;
